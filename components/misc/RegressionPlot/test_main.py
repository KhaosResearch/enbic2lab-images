...
def test_homogeneity_plot():
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        # mpimg.imread(os.path.join(tmp_dir, "regplot.png"))
        # plt.show()

        assert os.path.exists(os.path.join(tmp_dir, "regplot.pdf"))
        assert os.path.exists(os.path.join(tmp_dir, "regplot.png"))
        assert os.path.exists(os.path.join(tmp_dir, "regplot.svg"))
