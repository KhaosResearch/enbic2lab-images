...
def random_forest(
    ...
    This function trains a Random Forest model and saves the results in the output path. It also saves the model in ONNX format and the metrics plots.
    ...
    fig, ax = plt.subplots(ncols=5, nrows=5, figsize=(50, 50))
    ...
    fig.savefig(f"{output}/forest.png", bbox_inches="tight", dpi=300)
