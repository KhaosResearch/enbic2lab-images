...
def naive_bayes(
    ...
    """Main function for the classification with Naive Bayes

    This function fits a Naive Bayes model to the given dataset, saves the model and plots the metrics.
