...
class TestMainFunction(unittest.TestCase):
    def setUp(self):
        ...
        with open(self.filepath, "w") as file:
            ...
            file.write("02/02/2023,2.0\n")
            file.write("03/03/2023,20.0\n")
            file.write("04/04/2023,0.0\n")
            file.write("05/05/2023,12.0\n")
            file.write("06/06/2023,5.0\n")
            file.write("07/07/2023,4.0\n")
